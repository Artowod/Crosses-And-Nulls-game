...
public class CrossAndNull extends JFrame {
	...
	CrossAndNull() {
		...
		ActionListener bAction = new action();
	...
	private void sop() //show all fields
	{ String q,w,e;
		for(int y=0;y<3;y++){
	...
	{ boolean b=false;
		for (int x=0; x<3;x++){
	    if (mas[x][0]==1 && mas[x][1]==1 && mas[x][2]==1) {  //X - columns check
	    	if(x==0){
	    		jButtonWinner1=b1;
	    		jButtonWinner2=b4; 
	    		jButtonWinner3=b7;
		...
		if (mas[x][0]==2 && mas[x][1]==2 && mas[x][2]==2) {//O - columns check
	    	if(x==0){
	    		jButtonWinner1=b1;
	    		jButtonWinner2=b4; 
	    		jButtonWinner3=b7;
		...
		if (mas[0][x]==1 && mas[1][x]==1 && mas[2][x]==1) { //X - rows check
	    	if(x==0){
	    		jButtonWinner1=b1;
	    		jButtonWinner2=b2; 
	    		jButtonWinner3=b3;
		...
		if (mas[0][x]==2 && mas[1][x]==2 && mas[2][x]==2){ //O - rows check
	    	if(x==0){
	    		jButtonWinner1=b1;
	    		jButtonWinner2=b2; 
	    		jButtonWinner3=b3;
		...
		if (mas[0][0]==1 && mas[1][1]==1 && mas[2][2]==1){ //X - diagonal check
			b=true;
	    		jButtonWinner1=b1;
	    		jButtonWinner2=b5; 
	    		jButtonWinner3=b9;
	    }
		if (mas[0][0]==2 && mas[1][1]==2 && mas[2][2]==2){ //O - diagonal check
			b=true;
    		jButtonWinner1=b1;
    		jButtonWinner2=b5; 
    		jButtonWinner3=b9;
		}
		if (mas[2][0]==1 && mas[1][1]==1 && mas[0][2]==1){ //X - diagonal check
			b=true;
    		jButtonWinner1=b3;
    		jButtonWinner2=b5; 
    		jButtonWinner3=b7;
		}
		if (mas[2][0]==2 && mas[1][1]==2 && mas[0][2]==2){ //O - diagonal check
			b=true;
			jButtonWinner1=b3;
			jButtonWinner2=b5; 
			jButtonWinner3=b7;
